...
<p align = "justify"> O Backlog é um artefato que sintetíza os recursos de um produto definidos pelo product owner. Por ser um artefato construído de forma incremental, ele pode ser alterado no decorrer do projeto e, por isso, é mais habitual que ele começe com funcionalidades mais genéricas e vá evoluindo comforme a equipe de desenvolvimento adquire mais conhecimento do produto.</p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);">Eu, como um gestor de rifas, desejo visualiar os compradores de uma das rifas abertas.</td>
        </tr>
        </tr>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);"> Eu, como um gestor de rifas, desejo esquelher quantos números serão abertos</td>
        </tr>
        </tr>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);">Eu, como comprador, desejo visualizar vencedor / número sorteado de uma rifa fechada.</td>
        </tr>
        <tr>
