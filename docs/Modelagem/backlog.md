...
<p align = "justify">
Para levantar os recursos que seriam listados neste documento, foi utilizada a técnica de Road Map, e a partir disso foram criadas algumas histórias de usuário em uma tabela, que foram priorizadas de acordo com a técnica de priorização MoSCoW e que será apresentada a seguir.
</p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;text-align:center;border: 0.5px solid rgba(0,0,0,0.2);">Gestor</td> 
