...
maneiras de fazer isso é utilizando recursos de modelagem.
...
|              ![Gateway Paralelismo](../assets/img.png)              | Indica que ao passar por esse elemento, o processo será paralelizado. (Uma seta apontando para o elemento) |
|                         ![img.png](img.png)                         |      Indica que o processo, antes paralelizado, será mergeado (Duas setas apontando para o elemento)       |
|                       ![img_1.png](img_1.png)                       |                        Indica um arquivo consultável elaborado pela própria equipe                         |
|                       ![img_3.png](img_3.png)                       |                       Indica uma relação de sequência entre dois processos distintos                       |
|                       ![img_4.png](img_4.png)                       |                     Indica um arquivo consultável disponível em outras fontes onlines                      |
|                       ![img_5.png](img_5.png)                       |                         Indica um agrupamento de fluxo com propósitos semelhantes                          |
|                       ![img_6.png](img_6.png)                       |               Elemento que engloba um processo para indicar seu domínio e seus participantes               |
|                       ![img_2.png](img_2.png)                       |                                      Indica a finalização do processo                                      |
